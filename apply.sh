...
original_author="ash-oakenthorne"
original_name="studious_eureka_moment"
original_urlname="studious_eureka_moment"
original_description="Awesome studious_eureka_moment created by ash-oakenthorne" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/studious_eureka_moment "${name}"
...
then
    ...
    echo "then run 'studious_eureka_moment' or 'python -m studious_eureka_moment'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'studious_eureka_moment' or 'python -m studious_eureka_moment' or 'poetry run studious_eureka_moment'"
fi
